...
$matriz_trancisiones = [1  => ["letra" => 2, "digito"  => 17, "," => 27, ";" => 28, "<" => 32, ">" => 29, "=" => 25, '"' => 4, "+" => 19, "-" => 22, "*" => 26, "/" => 8, "&" => 37, "|" => 38, "~" => 39],
                        ...
                        4  => ["letra" => 5, "digito"  => 5 , "otro" => 5],
                        5  => ["letra" => 5, "digito"  => 5 , "otro" => 5 , '"' => 6],
                        ...
                        14 => ["letra" => 14, "digito" => 14, "." => 15, "," => 15, ";" => 15, "<" => 15, ">" => 15, "=" => 15, '"' => 15, "+" => 15, "-" => 15, "*" => 15, "/" => 15, "&" => 15, "|" => 15, "~" => 15, "otro" => 15],
                        17 => ["letra" => 18, "digito" => 17, "." => 40, "," => 18, ";" => 18, "<" => 18, ">" => 18, "=" => 18, '"' => 18, "+" => 18, "-" => 18, "*" => 18, "/" => 18, "&" => 18, "|" => 18, "~" => 18, "otro" => 18],
                        19 => ["letra" => 20, "digito" => 20, "." => 20, "," => 20, ";" => 20, "<" => 20, ">" => 20, "=" => 20, '"' => 20, "+" => 21, "-" => 20, "*" => 20, "/" => 20, "&" => 20, "|" => 20, "~" => 20, "otro" => 20],
                        22 => ["letra" => 23, "digito" => 23, "." => 23, "," => 23, ";" => 23, "<" => 23, ">" => 23, "=" => 23, '"' => 23, "+" => 23, "-" => 24, "*" => 23, "/" => 23, "&" => 23, "|" => 23, "~" => 23, "otro" => 23],
                        29 => ["letra" => 30, "digito" => 30, "." => 30, "," => 30, ";" => 30, "<" => 30, ">" => 30, "=" => 31, '"' => 30, "+" => 30, "-" => 30, "*" => 30, "/" => 30, "&" => 30, "|" => 30, "~" => 30, "otro" => 30],
                        32 => ["letra" => 33, "digito" => 33, "." => 33, "," => 33, ";" => 33, "<" => 33, ">" => 36, "=" => 35, '"' => 33, "+" => 33, "-" => 34, "*" => 33, "/" => 33, "&" => 33, "|" => 33, "~" => 33, "otro" => 33],
                        40 => ["digito" => 41],
                        41 => ["letra" => 42, "digito" => 41, "." => 42, "," => 42, ";" => 42, "<" => 42, ">" => 42, "=" => 42, '"' => 42, "+" => 42, "-" => 42, "*" => 42, "/" => 42, "&" => 42, "|" => 42, "~" => 42, "otro" => 42],
                        ];
